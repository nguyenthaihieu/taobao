...
<section id="container">
                ...
                <div class="minus">
                    ...
                    if ($_SERVER['REQUEST_METHOD']=='POST') { //если инициирована форма
                        ...
                        switch ($_POST['location']) {
                            case 'city--abakan': $location_jde='1';
                                $location_rus='Абакан';
                                $location_nrg='';
                                break;
                            case 'city--anadyr': $location_jde='0';
                                $location_rus='Анадырь';
                                $location_nrg='';
                                break;
                            case 'city--anapa': $location_jde='0';
                                $location_rus='Анапа';
                                $location_nrg='';
                                break;
                            case 'city--arhangelsk': $location_jde='103';
                                $location_rus='Архангельск';
                                $location_nrg='';
                                break;
                            case 'city--astrahan': $location_jde='4';
                                $location_rus='Астрахань';
                                $location_nrg='';
                                break;
                            case 'city--barnaul': $location_jde='7';
                                $location_rus='Барнаул';
                                $location_nrg='';
                                break;
                            case 'city--belgorod': $location_jde='8';
                                $location_rus='Белгород';
                                $location_nrg='';
                                break;
                            case 'city--birobidzhan': $location_jde='12';
                                $location_rus='Биробиджан';
                                $location_nrg='';
                                break;
                            case 'city--blagoveshhensk': $location_jde='13';
                                $location_rus='Благовещенск';
                                $location_nrg='';
                                break;
                            case 'city--brjansk': $location_jde='15';
                                $location_rus='Брянск';
                                $location_nrg='';
                                break;
                            case 'city--velikij-novgorod': $location_jde='105';
                                $location_rus='Великий Новгород';
                                $location_nrg='';
                                break;
                            case 'city--vladivostok': $location_jde='16';
                                $location_rus='Владивосток';
                                $location_nrg='';
                                break;
                            case 'city--vladikavkaz': $location_jde='0';
                                $location_rus='Владикавказ';
                                $location_nrg='';
                                break;
                            case 'city--vladimir': $location_jde='17';
                                $location_rus='Владимир';
                                $location_nrg='';
                                break;
                            case 'city--volgograd': $location_jde='18';
                                $location_rus='Волгоград';
                                $location_nrg='';
                                break;
                            case 'city--vologda': $location_jde='20';
                                $location_rus='Вологда';
                                $location_nrg='';
                                break;
                            case 'city--vorkuta': $location_jde='0';
                                $location_rus='Воркута';
                                $location_nrg='';
                                break;
                            case 'city--voronezh': $location_jde='21';
                                $location_rus='Воронеж';
                                $location_nrg='';
                                break;
                            case 'city--gorno-altajsk': $location_jde='0';
                                $location_rus='Горно-алтайск';
                                $location_nrg='';
                                break;
                            case 'city--groznyj': $location_jde='0';
                                $location_rus='Грозный';
                                $location_nrg='';
                                break;
                            case 'city--dudinka': $location_jde='0';
                                $location_rus='Дудинка';
                                $location_nrg='';
                                break;
                            case 'city--ekaterinburg': $location_jde='24';
                                $location_rus='Екатеринбург';
                                $location_nrg='';
                                break;
                            case 'city--elizovo': $location_jde='0';
                                $location_rus='Елизово';
                                $location_nrg='';
                                break;
                            case 'city--ivanovo': $location_jde='25';
                                $location_rus='Иваново';
                                $location_nrg='';
                                break;
                            case 'city--izhevsk': $location_jde='26';
                                $location_rus='Ижевск';
                                $location_nrg='';
                                break;
                            case 'city--irkutsk': $location_jde='27';
                                $location_rus='Иркутск';
                                $location_nrg='';
                                break;
                            case 'city--ioshkar-ola': $location_jde='28';
                                $location_rus='Йошкар-Ола';
                                $location_nrg='';
                                break;
                            case 'city--kazan': $location_jde='29';
                                $location_rus='Казань';
                                $location_nrg='';
                                break;
                            case 'city--kaliningrad': $location_jde='0';
                                $location_rus='Калининград';
                                $location_nrg='';
                                break;
                            case 'city--kaluga': $location_jde='31';
                                $location_rus='Калуга';
                                $location_nrg='';
                                break;
                            case 'city--kemerovo': $location_jde='32';
                                $location_rus='Кемерово';
                                $location_nrg='';
                                break;
                            case 'city--kirov': $location_jde='33';
                                $location_rus='Киров';
                                $location_nrg='';
                                break;
                            case 'city--kostomuksha': $location_jde='0';
                                $location_rus='Костомукша';
                                $location_nrg='';
                                break;
                            case 'city--kostroma': $location_jde='35';
                                $location_rus='Кострома';
                                $location_nrg='';
                                break;
                            case 'city--krasnodar': $location_jde='36';
                                $location_rus='Краснодар';
                                $location_nrg='';
                                break;
                            case 'city--krasnojarsk': $location_jde='37';
                                $location_rus='Красноярск';
                                $location_nrg='';
                                break;
                            case 'city--kurgan': $location_jde='38';
                                $location_rus='Курган';
                                $location_nrg='';
                                break;
                            case 'city--kursk': $location_jde='39';
                                $location_rus='Курск';
                                $location_nrg='';
                                break;
                            case 'city--kyzyl': $location_jde='0';
            $location_rus='Кызыл';
            $location_nrg='';
            break;
        case 'city--lipeck': $location_jde='40';
            $location_rus='Липецк';
            $location_nrg='';
            break;
        case 'city--magadan': $location_jde='41';
            $location_rus='Магадан';
            $location_nrg='';
            break;
        case 'city--magnitogorsk': $location_jde='42';
            $location_rus='Магнитогорск';
            $location_nrg='';
            break;
        case 'city--majkop': $location_jde='0';
            $location_rus='Майкоп';
            $location_nrg='';
            break;
        case 'city--mahachkala': $location_jde='111';
            $location_rus='Махачкала';
            $location_nrg='';
            break;
        case 'city--mineralnye-vody': $location_jde='0';
            $location_rus='Минеральные Воды';
            $location_nrg='';
            break;
        case 'city--mirnyj': $location_jde='0';
            $location_rus='Мирный';
            $location_nrg='';
            break;
        case 'city--moskva': $location_jde='44';
            $location_rus='Москва';
            $location_nrg='';
            break;
        case 'city--murmansk': $location_jde='100';
            $location_rus='Мурманск';
            $location_nrg='';
            break;
        case 'city--mytishhi': $location_jde='0';
            $location_rus='Мытищи';
            $location_nrg='';
            break;
        case 'city--naberezhnye-chelny': $location_jde='45';
            $location_rus='Набережные Челны';
            $location_nrg='';
            break;
                                    case 'city--nadym': $location_jde='0';
            $location_rus='Надым';
            $location_nrg='';
            break;
        case 'city--nazran': $location_jde='0';
            $location_rus='Назрань';
            $location_nrg='';
            break;
        case 'city--nalchik': $location_jde='0';
            $location_rus='Нальчик';
                                        $location_nrg='';
                                        break;
        case 'city--narjan-mar': $location_jde='0';
            $location_rus='Нарьян-Мар';
            $location_nrg='';
            break;
        case 'city--nerjungri': $location_jde='47';
            $location_rus='Нерюнгри';
            $location_nrg='';
            break;
        case 'city--neftejugansk': $location_jde='0';
                                        $location_rus='Нефтеюганск';
            $location_nrg='';
                                    break;
                                case 'city--nizhnevartovsk': $location_jde='49';
                                    $location_rus='Нижневартовск';
                                    $location_nrg='';
                                    break;
        case 'city--nizhnij-novgorod': $location_jde='50';
            $location_rus='Нижний Новгород';
            $location_nrg='';
            break;
        case 'city--novokuzneck': $location_jde='52';
            $location_rus='Новокузнецк';
            $location_nrg='';
            break;
        case 'city--novorossijsk': $location_jde='53';
            $location_rus='Новороссийск';
            $location_nrg='';
            break;
        case 'city--novosibirsk': $location_jde='54';
            $location_rus='Новосибирск';
            $location_nrg='';
            break;
        case 'city--novyj-urengoj': $location_jde='55';
            $location_rus='Новый Уренгой';
            $location_nrg='';
            break;
        case 'city--norilsk': $location_jde='0';
            $location_rus='Норильск';
            $location_nrg='';
            break;
        case 'city--nojabrsk': $location_jde='56';
            $location_rus='Ноябрьск';
            $location_nrg='';
            break;
                    case 'city--omsk': $location_jde='57';
            $location_rus='Омск';
            $location_nrg='';
                        break;
        case 'city--orel': $location_jde='58';
            $location_rus='Орел';
            $location_nrg='';
            break;
        case 'city--orenburg': $location_jde='59';
            $location_rus='Оренбург';
            $location_nrg='';
            break;
        case 'city--penza': $location_jde='60';
            $location_rus='Пенза';
            $location_nrg='';
            break;
        case 'city--perm': $location_jde='61';
            $location_rus='Пермь';
            $location_nrg='';
            break;
        case 'city--petrozavodsk': $location_jde='62';
            $location_rus='Петрозаводск';
            $location_nrg='';
            break;
        case 'city--petropavlovsk-kamchatskij': $location_jde='63';
            $location_rus='Петропавловск-Камчатский';
            $location_nrg='';
            break;
        case 'city--pskov': $location_jde='108';
            $location_rus='Псков';
            $location_nrg='';
            break;
        case 'city--rostov-na-donu': $location_jde='65';
            $location_rus='Ростов-на-Дону';
            $location_nrg='';
            break;
        case 'city--rjazan': $location_jde='66';
            $location_rus='Рязань';
            $location_nrg='';
            break;
        case 'city--salehard': $location_jde='0';
            $location_rus='Салехард';
            $location_nrg='';
            break;
        case 'city--samara': $location_jde='67';
            $location_rus='Самара';
            $location_nrg='';
            break;
        case 'city--sankt-peterburg': $location_jde='68';
            $location_rus='Санкт-Петербург';
            $location_nrg='';
            break;
        case 'city--saransk': $location_jde='69';
            $location_rus='Саранск';
            $location_nrg='';
            break;
        case 'city--saratov': $location_jde='70';
            $location_rus='Саратов';
            $location_nrg='';
            break;
        case 'city--smolensk': $location_jde='71';
            $location_rus='Смоленск';
            $location_nrg='';
            break;
        case 'city--sochi': $location_jde='72';
            $location_rus='Сочи';
            $location_nrg='';
            break;
        case 'city--stavropol': $location_jde='73';
            $location_rus='Ставрополь';
            $location_nrg='';
            break;
        case 'city--strezhevoj': $location_jde='0';
            $location_rus='Стрежевой';
            $location_nrg='';
            break;
        case 'city--surgut': $location_jde='76';
            $location_rus='Сургут';
            $location_nrg='';
            break;
        case 'city--syktyvkar': $location_jde='104';
            $location_rus='Сыктывкар';
            $location_nrg='';
            break;
        case 'city--tambov': $location_jde='78';
            $location_rus='Тамбов';
            $location_nrg='';
            break;
        case 'city--tver': $location_jde='99';
            $location_rus='Тверь';
            $location_nrg='';
            break;
        case 'city--toljatti': $location_jde='79';
            $location_rus='Тольятти';
            $location_nrg='';
            break;
        case 'city--tomsk': $location_jde='80';
            $location_rus='Томск';
            $location_nrg='';
            break;
        case 'city--tula': $location_jde='81';
            $location_rus='Тула';
            $location_nrg='';
            break;
        case 'city--tynda': $location_jde='0';
            $location_rus='Тында';
            $location_nrg='';
            break;
        case 'city--tjumen': $location_jde='82';
            $location_rus='Тюмень';
            $location_nrg='';
            break;
        case 'city--ulan-udje': $location_jde='83';
            $location_rus='Улан-Удэ';
            $location_nrg='';
            break;
        case 'city--uljanovsk': $location_jde='84';
            $location_rus='Ульяновск';
            $location_nrg='';
            break;
        case 'city--usinsk': $location_jde='0';
            $location_rus='Усинск';
            $location_nrg='';
            break;
        case 'city--ufa': $location_jde='86';
            $location_rus='Уфа';
            $location_nrg='';
            break;
        case 'city--uhta': $location_jde='0';
            $location_rus='Ухта';
            $location_nrg='';
            break;
        case 'city--khabarovsk': $location_jde='87';
            $location_rus='Хабаровск';
            $location_nrg='';
            break;
        case 'city--khanty-mansijsk': $location_jde='88';
            $location_rus='Ханты-Мансийск';
            $location_nrg='';
            break;
        case 'city--kholmsk': $location_jde='0';
            $location_rus='Холмск';
            $location_nrg='';
            break;
        case 'city--cheboksary': $location_jde='90';
            $location_rus='Чебоксары';
            $location_nrg='';
            break;
        case 'city--cheljabinsk': $location_jde='91';
            $location_rus='Челябинск';
            $location_nrg='';
            break;
        case 'city--cherepovec': $location_jde='102';
            $location_rus='Череповец';
            $location_nrg='';
            break;
        case 'city--cherkessk': $location_jde='0';
            $location_rus='Черкесск';
            $location_nrg='';
            break;
        case 'city--chita': $location_jde='92';
            $location_rus='Чита';
            $location_nrg='';
            break;
        case 'city--elista': $location_jde='0';
            $location_rus='Элиста';
            $location_nrg='';
            break;
        case 'city--yuzhno-sahalinsk': $location_jde='95';
            $location_rus='Южно-Сахалинск';
            $location_nrg='';
            break;
        case 'city--yakutsk': $location_jde='96';
            $location_rus='Якутск';
            $location_nrg='';
            break;
        case 'city--yaroslavl': $location_jde='97';
            $location_rus='Ярославль';
            $location_nrg='';
            break;
        default: $location_jde='0';
            $location_rus='0';
            $location_nrg='0';
    };
    if($location_jde<>0) { //если город для ЖДЕ подходит
        ...
        $price_jde = preg_replace("/ +/i", "", $price_jde);
