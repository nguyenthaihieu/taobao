...
function custom_gravatars($avatar_defaults)
{
    ...
    $customGravatar1 = get_bloginfo('template_directory') . '/img/ava.gif';
    $avatar_defaults[$customGravatar1] = 'Default';

    // add a custom user gravatar
    $customGravatar2 = get_bloginfo('template_directory') . '/img/ava.gif';
    $avatar_defaults[$customGravatar2] = 'Custom Gravatar';

    // add another custom gravatar
    $customGravatar3 = get_bloginfo('template_directory') . '/img/ava.gif';
...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
    <div id="comment-<?php comment_ID(); ?>">
        <div class="coment">
            <div class="ava">
                <?php echo get_avatar($comment, 35, get_bloginfo('template_directory') . '/img/ava.gif'); ?>
            </div>
            <div class="boxer">
                <p> <?php printf(__('%s'), get_comment_author_link()) ?> <span
                    class="date"><?php printf(__('%1$s at %2$s'), get_comment_date(), get_comment_time()) ?>
                    <?php
                    $author = get_comment_author_url();
                    echo substr_replace($author, "", 0, 7);
                    ?>
                    </span> <a
                    href="<?php echo htmlspecialchars(get_comment_link($comment->comment_ID)) ?>"></a><?php edit_comment_link(__('(Edit)'), '  ', '') ?>
                </p>
